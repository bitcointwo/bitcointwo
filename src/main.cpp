...
uint256 hashGenesisBlock("0x1bb887ec35d099762cef529d1cea6b0624f9c835be346dd04d3a015fffbddd1b");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(505094230); // Bitcointwo: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Bitcointwo Signed Message:\n";
...
{
    // Bitcointwo: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 100000); // Bitcointwo: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 202400; // Bitcointwo: 3.5 days
static const int64 nTargetSpacing = 100; // Bitcointwo: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Bitcointwo: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Bitcointwo: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Bitcointwo: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x68d22282a7c4cc1b813b957115d65e6183718fa497dfdf8ce9dd9ef0ef4c205b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "cnn 12/09/2016 Hillary Clinton stumbles -- will her campaign follow";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("59ffefe32fc807db60f9f83e2766797398e7521cedc7c3b77c04fca7e5654fe7609598a5b2463c062a25a179dc63ae6042bf6b7cdba571c23f9d0132863d0d7de6") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1473670512;
        block.nBits    = 505094230;
        block.nNonce   = 1819787089;

        if (fTestNet)
        {
            block.nTime    = 1473670512;
            block.nNonce   = 3189403446;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xdc0beae15eb0b601c7b619917e770195962336bdd38c7d00af774007354011b7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Bitcointwo: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BitcointwoMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BitcointwoMiner : ProcessBlock, block not accepted");
    }
